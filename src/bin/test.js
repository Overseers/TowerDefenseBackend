...
(function(h) {
    ...
    function Z(a) {
        ...
        h.each(a, function(e) {
            if (
                ...
                (c = e.replace(b[0], b[2].toLowerCase())), (d[c] = e), 'o' ===
                    b[1] && Z(a[e]);
        });
        a._hungarianMap = d;
    }
    ...
    function Ia(a, b, c, d) {
        var e = [],
            ...
            G = function(a) {
                if (c === k || c === i)
                    (j = l[i]), (m = h.trim(a.innerHTML)), j && j._bAttrSrc
                        ? (
                              N(j.mData._)(d, m),
                              t(j.mData.sort, a),
                              t(j.mData.type, a),
    ...
    function lb(a) {
        ...
        for (c = l.length; b < c; b++)
            (f = l[b]), (d = h(f.nTh).addClass(f.sClass)), i && d.appendTo(e), a
                .oFeatures.bSort &&
                (
                ...
                ), f.sTitle != d[0].innerHTML && d.html(f.sTitle), Na(
                a,
                'header'
            )(a, d, f, m);
        i && ea(a.aoHeader, g);
    ...
    function vb(a) {
        ...
        for (g = 0; g < c; g++)
            (m = b[g]), (l = f[g]), (i =
                'function' == typeof m.mData
                    ? 'function'
                    : m.mData), G.columns.push({
                data: i,
                name: m.sName,
                searchable: m.bSearchable,
                orderable: m.bSortable,
                search: { value: l.sSearch, regex: l.bRegex },
            }), t('mDataProp_' + g, i), d.bFilter &&
                (
    ...
    function I(a, b, c) {
        for (var d = 0, e = 0, f = b.length, g, j; e < f; ) {
            ...
            for (j = c ? c[e].firstChild : null; g; )
                1 === g.nodeType && (c ? a(g, j, d) : a(g, d), d++), (g =
                    g.nextSibling), (j = c ? j.nextSibling : null);
            e++;
        }
    }
    function Fa(a) {
        ...
        if (d || (!t && !f && !e && j == V(a) && j == m.length))
            ...
            for (n = e = 0; n < i.length; n++)
                (k = h(m[n])), (g =
                    k.outerWidth() - k.width()), (k = p.bBounding
                    ? Math.ceil(m[n].getBoundingClientRect().width)
                    : k.outerWidth()), (e += k), (c[i[n]].sWidth = v(k - g));
            b.style.width = v(e);
            o.remove();
        }
        l && (b.style.width = v(l));
    ...
    function Hb(a, b) {
        for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++)
            (c = B(a, f, b, 'display') + ''), (c = c.replace(
                Yb,
                ''
            )), (c = c.replace(/&nbsp;/g, ' ')), c.length > d &&
                ((d = c.length), (e = f));
        return e;
    }
    function v(a) {
    ...
    function X(a) {
        ...
        for (a = 0; a < m.length; a++) {
            ...
            for (c = f.length; b < c; b++)
                (g = f[b]), (j = e[g].sType || 'string'), m[a]._idx === k &&
                    (m[a]._idx = h.inArray(m[a][1], e[g].asSorting)), d.push({
                    src: i,
                    col: g,
                    dir: m[a][1],
                    index: m[a]._idx,
    ...
    function wa(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            e = 0;
            for (f = b.length; e < f; e++)
                (g = b[e].src), h(D(a.aoData, 'anCells', g)).removeClass(
                    c + (2 > e ? e + 1 : 3)
                );
            e = 0;
            for (f = d.length; e < f; e++)
                (g = d[e].src), h(D(a.aoData, 'anCells', g)).addClass(
                    c + (2 > e ? e + 1 : 3)
                );
        }
        a.aLastSort = d;
                    ...
                    if (
                        ...
                        if (b.columns) {
                            ...
                            for (e = b.columns.length; d < e; d++)
                                (g = b.columns[d]), g.visible !== k &&
                                    (f[d].bVisible = g.visible), g.search !==
                                    k &&
                                    h.extend(
                                        a.aoPreSearchCols[d],
                                        Cb(g.search)
            ...
            for (e = c.length; d < e; d++)
                (f = c[d]), (b[f.name] =
                    'function' === typeof f.val
                        ? g(a, f.val, f)
                        : h.isPlainObject(f.val) ? {} : f.val), (b[
                    f.name
                ].__dt_wrapper = !0), s.extend(a, b[f.name], f.propExt);
        }
    };
    ...
    s.registerPlural = u = function(a, b, c) {
        ...
        s.register(b, function() {
            ...
            return a === this
                ...
                : a instanceof s
                  ? a.length
                    ? h.isArray(a[0]) ? new s(a.context, a[0]) : a[0]
                    : k
                  : a;
        });
    };
